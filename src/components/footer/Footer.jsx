...
const Footer = () => {
  return (
    <footer>
      <div className="logo">
        <img src="/src/assets/images/logo_branca.png" alt="logo" />
        <p>Propondo acesso fácil e divertido à informação e ao esporte.</p>
      </div>
      <div className="apoio">
        <h3>Apoio</h3>
        <ul>
      ...
      <div className="devs">
        <h3>Desenvolvido e idealizado por:</h3>
        <ul>
          <li className="devs-li">
            David Murillo
            <span>
              <a href="https://linkedin.com/in/murilloliveiraz">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  id="linkedin"
              ...
              <a href="https://github.com/murilloliveiraz">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  id="Github"
          ...
          <li className="devs-li">
            Davi dos Reis
            <span>
              <a href="https://linkedin.com/in/yasmingcv/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  id="linkedin"
              ...
              <a href="https://github.com/yasmingcv">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  id="Github"
